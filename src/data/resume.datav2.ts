  ...
  work: [
    {
      ...
      bullets: [
        'Engineered Node.js and Express.js microservices as sole backend developer on a 3-person team, for a white-label tax liquidation SaaS sold to accounting firms across Argentina, with ARCA regulatory integrations.',
  ...
  work: [
    {
      ...
      techStack: ['Node.js', 'Express.js', 'Kotlin', 'PostgreSQL', 'MySQL', 'Python', 'Selenium'],
      bullets: [
        'Desarrollé microservicios con Node.js y Express.js como único desarrollador backend en un equipo de 3 personas, para una SaaS de liquidación impositiva white-label vendida a estudios contables en Argentina, con integraciones regulatorias de ARCA.',
